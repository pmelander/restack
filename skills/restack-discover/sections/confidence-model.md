...
discovery": unknown actor behaviour → `/restack-discover actor <name>`; unclear
propagation → `/restack-discover intentions`; a moving system boundary →
`/restack-discover paths`; unmapped resistance → `/restack-discover organisation`.
