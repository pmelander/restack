...
| Read this | When |
|---|---|
| `skills/journey/sections/route-greenfield.md` | the terrain has been classified Greenfield and you are mapping or re-checking the route |
| `skills/journey/sections/route-brownfield.md` | the terrain has been classified Brownfield or Oilfield and you are mapping or re-checking the route |
| `skills/journey/sections/route-minefield.md` | the terrain has been classified Minefield and you are mapping or re-checking the route |
| `skills/journey/sections/route-ongoing.md` | the system is live and you are running /journey cadence, or the terrain has been classified Ongoing Evolution |
| `skills/journey/sections/terrain-classification.md` | running /journey start, or re-classifying terrain mid-journey because the ground has changed |
...
**Read** `skills/journey/sections/terrain-classification.md` and run the
...
**Read** `skills/journey/sections/route-ongoing.md` and work from it.
